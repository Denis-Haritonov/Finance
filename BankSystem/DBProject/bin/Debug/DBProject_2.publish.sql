...
GO
PRINT N'Creating [dbo].[FK_Client_Account]...';


GO
ALTER TABLE [dbo].[Client] WITH NOCHECK
    ADD CONSTRAINT [FK_Client_Account] FOREIGN KEY ([AccountId]) REFERENCES [dbo].[Account] ([Id]);
...
GO
ALTER TABLE [dbo].[Client] WITH CHECK CHECK CONSTRAINT [FK_Client_Account];
